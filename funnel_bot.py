...
REMINDERS = [
    (3600,  "⏰ Вы посмотрели урок?\n\nВнутри есть очень интересный разбор - два специалиста, одинаковый уровень знаний. Но один вызывает доверие, другой нет. Это не про контент. Это про то, как вас считывают. \n\nЕсли резонирует - вы знаете, где меня найти 👇"),
    (86400, "Один вопрос. \n\nКогда вы заходите в чужой блог и чувствуете "вот это дорого" - вы же понимаете, что это не про цены в шапке профиля? Это ощущение. Оно либо есть, либо нет. \n\nВ BRAND CODE я разбираю как его выстроить - конкретно, без абстракций. Местоь еще есть 👇"),
    (172800,"Закрываю набор завтра.\n\nЕсли урок отозвался - это ваш сигнал. Успейте 👇"),
]
